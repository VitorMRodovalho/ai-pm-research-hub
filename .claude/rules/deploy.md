...
2. `npm test` — 1442 pass, 0 fail, 42 skip (offline CI baseline); with DB env: 1491 pass, 0 fail, 5 skip (Phase C 3 tests + Q-C/p65/Pacote M unlocks) — last updated p175
