...
# MCP Server Rules (nucleo-mcp v2.73.0)

## Current State
- **291 tools + 4 prompts + 3 resources** (p197b v2.73.0 — +2 tools surfacing PERT cutoff to MCP: get_pert_cutoff_summary (read distribution + target + band) + compute_pert_cutoff (admin trigger, recompute against approved active members in prior cycles); pairs with frontend /admin/selection cutoff chip + ranking row color-code; was p197 v2.72.0 — submit_evaluation rich preview + new params criterion_notes_json/ai_suggestion_id; get_evaluation_form description bumped to reflect SQL p197 enrichment (cv_extracted_text, profile_*, service_history_*, pmi_memberships, returning_member_match, criteria_with_weights, pert_cutoff, max_weighted_subtotal); motivated by Fabricio MCP submit anomaly 2026-05-19 Luíse Quintana; tool count unchanged 289; was p193 v2.71.0 — get_tribes_comparison upgraded to V4 wrapping exec_cross_initiative_comparison instead of V3 get_cross_tribe_comparison; tool name preserved + new optional `kind` param + response shape upgraded to V4 envelope; tool count unchanged 289; was v2.70.0 p172 — meeting_close tool extended em p171 #9 Track B aceita suggested_champion_ids[] param; tool count unchanged 289; was v2.69.0 p165 — same 289 count; was 284 at p133 close; was 283 post p117 +get_extraction_health for ADR-0075; was 266 post p106 #97 W3 G4; was 217 = 141R + 76W at p77 marathon close — R/W split tracking dropped p106 since heuristic unreliable; total + canonical commit log replaces it)
