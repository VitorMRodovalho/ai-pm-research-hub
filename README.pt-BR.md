...
| **MCP** | Servidor customizado (50 ferramentas) | Assistentes de IA consultam a plataforma via linguagem natural |
...
|----------------|--------|
| Claude.ai | Verificado (50 ferramentas) |
