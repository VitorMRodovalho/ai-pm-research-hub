...
| **MCP** | Servidor customizado (47 ferramentas) | Assistentes de IA consultam a plataforma via linguagem natural |
...
|----------------|--------|
| Claude.ai | Verificado (47 ferramentas) |
