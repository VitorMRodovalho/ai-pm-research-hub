...
3. Finish replacing the remaining static home-cycle and event messaging with runtime schedule/config sources, especially event/meeting cards and any residual surfaces still depending on legacy event reads.
