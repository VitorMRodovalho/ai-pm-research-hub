...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer: {
      'pt-BR': 'Só publicações (artigo, e-book, estudo de caso, infográfico, report) passam por revisão. 1) Peer review: a tribo registra o feedback, ou dispensa com motivo se o artigo for colaborativo. 2) Revisão do líder: Aprovar, Dispensar ou Devolver com nota. 3) Curadoria: a plataforma designa 2 pareceristas, com prazo de 7 dias e lembrete 2 dias antes. Framework, webinar, ferramenta e POC vão só para o portfólio.',
      ...
      'es-LATAM': 'Solo las publicaciones (artículo, e-book, estudio de caso, infografía, report) pasan por revisión. 1) Revisión de pares: la tribu registra el feedback, o la dispensa con motivo si el artículo es colaborativo. 2) Revisión del líder: Aprobar, Dispensar o Devolver con nota. 3) Curaduría: la plataforma designa 2 revisores, con plazo de 7 días y recordatorio 2 días antes. Framework, webinar, herramienta y POC van solo al portafolio.',
    },
  },
  {
