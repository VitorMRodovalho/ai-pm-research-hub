...
function useTranslatedBoardI18n(overrides?: BoardI18n): BoardI18n {
  ...
  return {
    ...
    // #2447: classificação de artefato
    portfolioFlagLabel: t('comp.board.portfolioFlagLabel', DEFAULT_I18N.portfolioFlagLabel),
    portfolioFlagHint: t('comp.board.portfolioFlagHint', DEFAULT_I18N.portfolioFlagHint),
    artifactTypeLabel: t('comp.board.artifactTypeLabel', DEFAULT_I18N.artifactTypeLabel),
    artifactTypeNone: t('comp.board.artifactTypeNone', DEFAULT_I18N.artifactTypeNone),
    artifactSubtypeLabel: t('comp.board.artifactSubtypeLabel', DEFAULT_I18N.artifactSubtypeLabel),
    artifactSubtypeNone: t('comp.board.artifactSubtypeNone', DEFAULT_I18N.artifactSubtypeNone),
    artifactSuggested: t('comp.board.artifactSuggested', DEFAULT_I18N.artifactSuggested),
    artifactUseSuggestion: t('comp.board.artifactUseSuggestion', DEFAULT_I18N.artifactUseSuggestion),
    artifactGoesToCuration: t('comp.board.artifactGoesToCuration', DEFAULT_I18N.artifactGoesToCuration),
    ...
    // #2456: erros do fluxo de revisão
    reviewErrSession: t('comp.board.reviewErrSession', DEFAULT_I18N.reviewErrSession),
    reviewErrNotFound: t('comp.board.reviewErrNotFound', DEFAULT_I18N.reviewErrNotFound),
    reviewErrStale: t('comp.board.reviewErrStale', DEFAULT_I18N.reviewErrStale),
    reviewErrPermission: t('comp.board.reviewErrPermission', DEFAULT_I18N.reviewErrPermission),
    reviewErrNotArtifact: t('comp.board.reviewErrNotArtifact', DEFAULT_I18N.reviewErrNotArtifact),
    reviewErrWaiverReason: t('comp.board.reviewErrWaiverReason', DEFAULT_I18N.reviewErrWaiverReason),
    reviewErrInvalid: t('comp.board.reviewErrInvalid', DEFAULT_I18N.reviewErrInvalid),
