...
export const TRIBES: Tribe[] = [
  ...
  // Tribe 2 (Agentes Autônomos) — archived in C4 with Débora Moura's departure (is_active=false in DB, #1215)
  ...
  },
  {
    ...
    leader: 'Messias Reis da Silva', // C4 transition Fabricio -> Messias (#1116 / ADR-0121)
    leaderLinkedIn: '',
    quadrant: 'q3',
  ...
  // ── Ciclo 4 — novas tribos (#1116). Sem vídeo/entregáveis/agenda fixos ainda;
  //    nome/agenda hidratam do DB (tribes.name_i18n / tribe_meeting_slots) em runtime.
  {
    id: 9,
    nameKey: 'data.tribe9.name',
    leader: 'Henrique Diniz',
    leaderLinkedIn: '',
    quadrant: 'q2',
  ...
  {
    id: 11,
    nameKey: 'data.tribe11.name',
    leader: 'João Henrique Jacinto',
    leaderLinkedIn: '',
    quadrant: 'q2',
  ...
  {
    id: 12,
    nameKey: 'data.tribe12.name',
    leader: 'Jhonathan Brandao',
    leaderLinkedIn: '',
    quadrant: 'q1',
  ...
  // ── Ciclo 4 — reorg 2026-07-08: 2 tribos novas (DB tribes 13/14; ver #1219).
  {
    id: 13,
    nameKey: 'data.tribe13.name',
    leader: 'Adailson Santos',
    leaderLinkedIn: '',
    quadrant: 'q2',
  ...
  {
    id: 14,
    nameKey: 'data.tribe14.name',
    leader: 'Paulo Alves Jr',
    leaderLinkedIn: '',
    quadrant: 'q1',
