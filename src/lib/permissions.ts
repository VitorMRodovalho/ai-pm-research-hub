...
export const TIER_LABELS: Record<OperationalTier, { pt: string; en: string; es: string; icon: string }> = {
  ...
  tribe_leader:         { pt: 'Líder de CoP',            en: 'CoP Leader',             es: 'Líder de CoP',             icon: '⚡' },
  ...
  cop_participant:      { pt: 'Participante de CoP',     en: 'CoP Participant',        es: 'Participante de CoP',       icon: '👥' },
  cop_observer:         { pt: 'Observador de CoP',       en: 'CoP Observer',           es: 'Observador de CoP',         icon: '👁️' },
