...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'board-comms',    labelKey: 'nav.boardComms',      href: '/admin/board/a6b78238-11aa-476a-b7e2-a674d224fd79', minTier: 'member', requiresAuth: true, section: 'drawer', group: 'subprojects', drawerSection: 'producao', allowedDesignations: ['comms_leader', 'comms_member', 'curator', 'co_gp'] },
  { key: 'board-publications', labelKey: 'nav.boardPublications', href: '/admin/board/86a8959c-ddd0-4a7f-b45f-bf828230f949', minTier: 'member', requiresAuth: true, section: 'drawer', group: 'subprojects', drawerSection: 'producao', allowedDesignations: ['comms_leader', 'comms_member', 'curator', 'co_gp'] },
  ...
  { key: 'stakeholder-dashboard', labelKey: 'nav.stakeholder', href: '/stakeholder', minTier: 'member', requiresAuth: true, section: 'drawer', group: 'admin-sub', drawerSection: 'admin', navSlot: 'none', allowedDesignations: ['sponsor', 'chapter_liaison'] },
  ...
  { key: 'admin-chapter-report', labelKey: 'nav.adminChapterReport', href: '/admin/chapter-report', minTier: 'observer', requiresAuth: true, section: 'main', group: 'admin-sub', navSlot: 'none', allowedDesignations: ['sponsor', 'chapter_liaison'] },
  { key: 'admin-sustainability', labelKey: 'nav.adminSustainability', href: '/admin/sustainability', minTier: 'admin', requiresAuth: true, section: 'main', group: 'admin-sub', navSlot: 'none', allowedDesignations: ['sponsor', 'chapter_liaison', 'curator'] },
