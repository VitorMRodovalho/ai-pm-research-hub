...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'admin-agenda-viva', labelKey: 'nav.adminAgendaViva', href: '/admin/agenda-viva', minTier: 'admin', requiresAuth: true, section: 'main', group: 'admin-sub', navSlot: 'none', allowedDesignations: ['deputy_manager', 'co_gp', 'comms_leader'], allowedOperationalRoles: ['manager'] },
