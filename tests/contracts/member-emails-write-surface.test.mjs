...
test('GAP-205.D + #411 + #191 + #188 + #415 + #459 + #209: /health endpoint reports /mcp tools = 311 (matches catalog ratchet)', () => {
  ...
  assert.equal(count, 311,
    `/health /mcp surface tools count must equal 311 (308 after #459 get_governance_document_body, ` +
    `plus 3 drive revocation tools from #209). Source-of-truth is the runtime tools/list, but the /health label ` +
