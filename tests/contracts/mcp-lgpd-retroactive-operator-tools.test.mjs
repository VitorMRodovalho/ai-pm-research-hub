...
test('ef_version is 2.92.0 (#1613 stage_override no interview_manage; 2.91.0 no #1598)', () => {
  assert.match(EF, /ef_version:\s*"2\.92\.0"/, '/health must report ef_version 2.92.0');
});
