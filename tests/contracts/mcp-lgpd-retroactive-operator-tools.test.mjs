...
test('ef_version is 2.81.0 (#1383 Wave 1 semantic surface; was 2.80.0 at p239b #332)', () => {
  assert.match(EF, /ef_version:\s*"2\.81\.0"/, '/health must report ef_version 2.81.0');
});
