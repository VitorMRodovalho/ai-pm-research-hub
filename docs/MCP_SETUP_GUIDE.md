...
MCP (Model Context Protocol) is an open protocol that allows AI assistants to interact with external services. The Núcleo server exposes 54 tools (46 read + 8 write) that let you query and manage project data directly from your AI assistant using natural language. A dynamic knowledge layer adapts guidance to each member's role and permissions.
...
| Client | Status | Notes |
|--------|--------|-------|
| Claude.ai | ✅ Verified (54 tools) | Web and desktop app. Streamable HTTP SSE. |
