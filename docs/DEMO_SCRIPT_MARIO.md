...
→ MCP Server com 52 ferramentas. Claude Chat consulta dados em tempo real. 6 hosts verificados (Claude.ai, Claude Code, ChatGPT, Perplexity, Cursor, Manus AI). PostHog analytics com dashboards nativos.
