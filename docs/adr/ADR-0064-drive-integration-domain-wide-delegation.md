...
- **Workspace dependency**: se conta `nucleoia@pmigo.org.br` for suspensa/perdida, todos writes parados (mesmo backup `redacted-085@example.com` não cobre upload via SA). Já era o SPOF aceito na Phase 1.
