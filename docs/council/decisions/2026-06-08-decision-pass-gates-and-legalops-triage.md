...
- #334 has **0 comments** = external clock not started. #332 CLOSED → the interim Art.18 §IV notification was **already sent** to the affected candidate ([REDACTED-332-NAME], 2026-05-24) → Angeline's template is **retroactive/canonical, no time pressure**.
