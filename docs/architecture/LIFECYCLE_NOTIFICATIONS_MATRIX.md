...
> **⚠️ Snapshot de infraestrutura (2026-05-20).** As linhas *descritivas* desta matriz
> (34 notification types, 8 lifecycle crons, 4.292 notificações/180d, contagens de
> engagements/templates) foram levantadas em 2026-05-20; o main avançou ~325 commits até o
> merge deste doc (2026-06-10, PR #202). A estrutura de estados/transições segue válida,
> mas **re-aterre qualquer número via query ao vivo antes de implementar os follow-ups**
> (regra de grounding do CLAUDE.md). Drift-watch mecanizado: P162 log #79 (WATCH-182.A).
