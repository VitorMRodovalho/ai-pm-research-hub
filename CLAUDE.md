...
- **Version:** v3.2.1 (Structural Quality) | 133 MCP tools (89R+44W) | 23 Edge Functions | 1339 unit + 40 e2e tests (1 pre-existing fail: exec_tribe_dashboard.events.tribe_id V4 drift — delimiter drift fix em p41 restaurou +21 passes)
