...
- **Version:** v3.2.1 (Structural Quality) | **217 MCP tools (141R+76W) + 4 prompts + 3 resources v2.46.0** | 24 Edge Functions | **1418** unit (**1383** pass DB-aware) + 40 e2e tests | **62 ADRs + 6 amendments** (p77 marathon: 12 commits, MCP +38 tools, Phase B'' 99→104/246 ~42.3%, perf -1 fk -5 mpp, Pattern 43 saturation 3x, Pattern 47 V3 false-positive — Onboarding 100% + Selection ~80% + Certs ~80% + Cycles ~80% + Knowledge/Wiki ~75% + Drift detector live + check_code_schema_drift MCP exposed) | Phase B'' V3→V4: **104/246 (~42.3%)**
