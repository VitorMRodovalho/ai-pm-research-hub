...
- **Version:** v3.2.1 (Structural Quality) | 138 MCP tools (92R+46W) | 23 Edge Functions | 1346 unit + 40 e2e tests (1 pre-existing fail: exec_tribe_dashboard.events.tribe_id V4 drift — delimiter drift fix em p41 restaurou +21 passes; +7 em p42 via role-ladder-parity enforcement)
