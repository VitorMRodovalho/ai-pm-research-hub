...
- **Version:** v3.2.1 (Structural Quality) | **157 MCP tools (101R+56W) v2.30.0** | 24 Edge Functions | **1415** unit (**1383** pass DB-aware) + 40 e2e tests | **49 ADRs** (latest: 0041-0049 p72+p73 — governance review + chapter dashboards + finance V4 + 2-of-N + #84 schema + #84 Onda 2 11/11 closed) | Phase B'' V3→V4: **99/246 tracked**; **pg_proc strict V3 scan: 0 violations** (all RPCs auth-gate via can_by_member); residual designation references in triggers/calculations/helpers are display-only and out of Phase B'' scope
