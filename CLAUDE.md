...
- **Version:** v3.2.1 (Structural Quality) | **228 MCP tools (151R+77W) + 4 prompts + 3 resources v2.50.0** | 25 Edge Functions (drive-list-folder-files added) | **1418** unit (**1383** pass DB-aware) + 40 e2e tests | **63 ADRs + 6 amendments** (p77 EXTREME-marathon: 24+ commits — handoff 25/Abr 5 items closed + Mayanna report 7 items closed (Drive Phase 1 schema+RPCs+EF skeleton, Phase 2 awaits PM Google Cloud setup) + ADR-0063 WhatsApp + drift v4 caught 3 LGPD broken + Phase B'' 99→105/246 + board_item_comments + 7MB upload + comms domain auth + curator V4 seed) | Phase B'' V3→V4: **105/246 (~42.7%)**
