...
- **Version:** v3.2.1 (Structural Quality) | **197 MCP tools (127R+70W) + 4 prompts + 3 resources v2.43.0** | 24 Edge Functions | **1418** unit (**1383** pass DB-aware) + 40 e2e tests | **62 ADRs + 6 amendments** (latest: #86 Wave 1 onboarding+selection coverage + ADR-0061 W6/W7/W8 — #86 Onboarding 75%→100% + Selection ~30%→~80% (15 tools wired) + ADR-0061 W8 LGPD cron health + W7 invitation health + W6 cross-initiative audit + ADR-0062 #101 P2 + W5 lifecycle closure + ADR-0059 W6 self-discovery — #84 Onda 2 closure + #101 backend complete + perf cleanup 12 dup-indexes + auth_rls_initplan batches 1-5 76/76 **100%** + preview_gate_eligibles hybrid cache + mpp batches 1-6 **58 WARN closed (~44% saturation)**) | Phase B'' V3→V4: **99/246 tracked**; **pg_proc strict V3 scan: 0 violations**; residual designation references display-only and out of Phase B'' scope
