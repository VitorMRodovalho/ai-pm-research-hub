...
- **Version:** v3.2.1 (Structural Quality) | **213 MCP tools (137R+76W) + 4 prompts + 3 resources v2.44.0** | 24 Edge Functions | **1418** unit (**1383** pass DB-aware) + 40 e2e tests | **62 ADRs + 6 amendments** (latest: #86 Wave 1 + Wave 2 coverage expansion — Onboarding 100% + Selection ~80% + Certificates 80% + Cycles 80% + Knowledge/Wiki ~75% + ADR-0061 W6/W7/W8 LGPD/invitation/cross-init audit observability — 31 tools wired in 2 waves; remaining gaps in Financial 0% (no RPCs to wire) + XP discretionary mechanism (no RPC yet) | perf cleanup 12 dup-indexes + auth_rls_initplan 76/76 **100%** + mpp **58 WARN closed (~44% saturation)**) | Phase B'' V3→V4: **99/246 tracked**; **pg_proc strict V3 scan: 0 violations**
