...
- **Version:** v3.2.1 (Structural Quality) | 101 MCP tools (73R+28W) | 23 Edge Functions | 1318 unit + 40 e2e tests (22 pre-existing fails em exec_tribe_dashboard/curation usam delimiter `$function$` vs regex `$$` — drift não-blocker)
