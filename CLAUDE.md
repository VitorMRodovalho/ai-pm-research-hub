...
- **Version:** v3.2.1 (Structural Quality) | 142 MCP tools (95R+47W) | 23 Edge Functions | 1361 unit + 40 e2e tests (1 pre-existing fail: exec_tribe_dashboard.events.tribe_id V4 drift — delimiter drift fix em p41 restaurou +21 passes; +7 em p42 via role-ladder-parity enforcement; +15 em p44 via mcp-rate-limit unit tests)
