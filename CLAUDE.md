...
- **Version:** v3.2.1 (Structural Quality) | **216 MCP tools (140R+76W) + 4 prompts + 3 resources v2.45.0** | 24 Edge Functions | **1418** unit (**1383** pass DB-aware) + 40 e2e tests | **62 ADRs + 6 amendments** (latest: #86 Wave 1+2 + #81 closure + #99 W2/W3 observability — Onboarding 100% + Selection ~80% + Certificates 80% + Cycles 80% + Knowledge/Wiki ~75% + Drift detector + Audit checklist + Silent-error gate + Pattern 43 reuse 3x (invitation/LGPD/digest health) — 35 tools wired in p77; remaining: Financial 0% + XP discretionary + digest content gap on attendance_reminder/assignment_new (PM design) | perf 12 dup-indexes + auth_rls_initplan **100%** + mpp **58 WARN closed**) | Phase B'' V3→V4: **99/246**; **pg_proc strict V3 scan: 0**
