...
| S-DB1 | Credly/Gamification Data Sanitation | High | Partial (v2 hardening pack 2026-03-08) | Added SQL pack (`audit + sanitize + runbook`) plus DB hardening scripts (partial unique index + rollback) to reconcile legacy Credly points, dedupe `gamification_points`, remove manual-vs-Credly double counting, and prevent future Credly duplicates at DB layer. |
