...
| W120 | PM AI Revolution Ambassador follow-up | Medium | Planned | Aplicação enviada em 11/fev/2026 para info@pmairevolution.com. Candidatos: Vitor Rodovalho + Fabricio Costa. Se aceito: conta como parceria externa + visibilidade global. Pendente resposta. |
| W121 | LATAM LIM 2026 submission | High | Planned | Submeter proposta do Núcleo ao LATAM LIM 2026 (convite encaminhado por Fabricio em 09/mar/2026). Se aceito e apresentado: conta como webinar/talk no KPI. Deadline a confirmar. |
| W122 | Carlos Novello Award follow-up | Low | Planned | Vitor indicado ao Voluntário do Ano PMI LATAM 2025 (Carlos Novello Award). Registrar como reconhecimento institucional na plataforma. |
| W123 | Partner pipeline management | Medium | Planned | 5 entidades em negociação (FioCruz, AI.Brasil, CEIA-UFG, IFG, PMO-GA). Precisa de UI para acompanhar pipeline de parcerias com status. Responsável por cada negociação deve ser atribuído na plataforma. |
