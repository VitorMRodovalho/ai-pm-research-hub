-- ═══════════════════════════════════════════════════════════════
-- Add `nature` field to get_attendance_grid events output
-- Why: AttendanceGridTab.tsx:273 had TODO to enable nature-based filter
-- (avulsa vs recorrente vs workshop). RPC already scopes by type but
-- doesn't expose nature to the client.
-- Rollback: keep signature, just rerun previous CREATE OR REPLACE without
-- the nature field.
-- ═══════════════════════════════════════════════════════════════
