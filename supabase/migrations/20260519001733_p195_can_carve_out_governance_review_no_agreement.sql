...
--
-- ROLLBACK: re-apply prior can() body without the OR clause.
-- ============================================================
--
-- RECOVERY NOTE (BUG-199.B p199-b, 2026-05-19): applied to DB live during
-- p195 via apply_migration MCP, but FS file was lost when Supabase fork-bomb
...
-- This file is functionally equivalent to 20260710000000_p195_can_carve_
-- out_governance_review.sql (CREATE OR REPLACE → idempotent re-apply).
-- ============================================================
