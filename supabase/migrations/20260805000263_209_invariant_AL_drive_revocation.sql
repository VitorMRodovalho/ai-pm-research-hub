-- #209 / ADR-0107: add invariant AL_drive_revocation_terminal_consistency.
-- Full CREATE OR REPLACE rebuild of check_schema_invariants (body-hash drift gate requires the
-- latest migration to carry the complete current body). Captured verbatim from live (latest was AK,
-- migration 20260805000259) + the new AL block appended before END.
