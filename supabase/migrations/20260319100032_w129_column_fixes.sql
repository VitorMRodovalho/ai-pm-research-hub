-- W129: Column Fix Migration (P0 — Production Broken)
-- ============================================================
-- BUG-2: exec_tribe_dashboard references m.certifications (doesn't exist)
-- BUG-3: exec_chapter_dashboard/exec_chapter_comparison reference a.status/a2.status
--         (attendance uses boolean 'present', not text 'status')
-- ============================================================

-- ============================================================
-- FIX BUG-2: exec_tribe_dashboard — remove m.certifications reference
-- ============================================================
...
-- ============================================================
-- FIX BUG-3a: exec_chapter_dashboard — a.status = 'present' → a.present = true
-- ============================================================
...
BEGIN
  ...
  -- Engagement (FIX: a.present = true instead of a.status = 'present')
  BEGIN
    SELECT jsonb_build_object(
...
-- ============================================================
-- FIX BUG-3b: exec_chapter_comparison — a2.status = 'present' → a2.present = true
-- ============================================================
