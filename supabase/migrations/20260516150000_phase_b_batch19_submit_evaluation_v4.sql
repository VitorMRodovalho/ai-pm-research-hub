-- Phase B'' batch 19.2: submit_evaluation V3 sa-bypass → V4 can_by_member('manage_platform')
...
CREATE OR REPLACE FUNCTION public.submit_evaluation(p_application_id uuid, p_evaluation_type text, p_scores jsonb, p_notes text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
