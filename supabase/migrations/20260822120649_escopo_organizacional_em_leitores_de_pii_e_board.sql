-- Autoridade de escopo organizacional nos leitores de PII de admin e na escrita
-- em board (decisao do PM 2026-08-22).
--
-- Tres RPCs de leitura de PII de admin e o gate de escrita em board aceitavam
-- capacidade escopada a uma iniciativa em contexto onde nao ha recurso a escopar.
-- Passam a exigir capacidade de escopo ORGANIZATION.
--
-- can() NAO foi alterada: a mudanca e aditiva, no helper e em quem chama.
--
-- Efeito medido antes e depois: quem tinha capacidade escopada a propria
-- iniciativa mantem tudo o que fazia; GP, co-GP, sponsors e pontos focais ficam
-- inalterados; ninguem legitimo perdeu acesso.
--
-- Contexto completo no security advisory privado do repositorio.
