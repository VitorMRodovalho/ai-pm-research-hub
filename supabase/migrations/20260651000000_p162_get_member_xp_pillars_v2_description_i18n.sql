-- p162 Fase A.2 v2 — include description_i18n + trigger_source in rule breakdown
-- Adds description_i18n so /profile/me can render contextual "como crescer" copy
-- in drilldown for pillars with 0 pts.
-- Adds trigger_source to distinguish manual (Champion) vs auto vs rpc_callback rules.
...
-- Rollback: revert to 20260650000000 body (without description_i18n + trigger_source in rules jsonb).
