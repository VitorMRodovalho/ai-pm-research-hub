-- p200 (OPP-196.E, ADR-0087 §2 Batch D, 2026-05-19): V4 swap
-- `'curator' = ANY(designations)` → `can_by_member('curate_content')` in
-- 2 fns with special semantics.
--
-- Functions touched:
--   _can_sign_gate          — gate kind 'curator' check (caller-as-signer)
--   assign_curation_reviewer — target-user (reviewer) curator validation
--                              [semantic note: passes p_reviewer_id, NOT caller]
