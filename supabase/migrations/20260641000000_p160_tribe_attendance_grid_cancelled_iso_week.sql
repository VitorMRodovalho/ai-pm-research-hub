-- p160 (2026-05-14): tribe attendance grid honors soft-cancelled events with ISO-week sibling rule
--
-- Business rule (PM 2026-05-14):
--  • Cancelled event WITHOUT replan in same ISO week → show with cells='na' (—)
--  • Cancelled event WITH another scheduled tribe event in same ISO week → hide
--
-- Keeps the V3-hybrid + historical members fixes from prior migration
-- (20260638000000) intact.
